...
<template>
  ...
  >
    <Container class="max-w-xl font-sans">
      <Section
        class="py-6 px-9 sm:px-6 bg-white dark:bg-gray-900rounded-lg"
        mso-style="padding: 24px 36px;"
      >
        <Link href="https://twiceware.de" class="mx-auto">
         <Logo />
        </Link>
      </Section>
      ...
      <Section class="py-6 px-9 sm:px-6" mso-style="padding: 24px 36px;">
        <Text class="m-0 text-sm text-stone-500 text-center leading-relaxed">
          <span class="font-bold">twiceware solutions e. K.</span>
          <br/>Inhaber Danny Spangenberg &middot; Belderberg 7 &middot; D-53111 Bonn<br>
