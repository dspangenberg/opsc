 ...
 * @property-read \App\Models\Contact|null $receiver_contact
 * @property-read \App\Models\Contact|null $sender_contact
 * @method static Builder<static>|Document contact(?int $contactId)
 * @method static \Database\Factories\DocumentFactory factory($count = null, $state = [])
 * @method static Builder<static>|Document issuedBetween($from, $to)
 * @method static Builder<static>|Document search(?string $search)
 * @mixin Eloquent
 */
