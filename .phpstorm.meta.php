...
'typescript-transformer.transform_null_to_optional','webauthn.relying_party.name','webauthn.relying_party.id','webauthn.origins','webauthn.challenge.bytes',
...
'sanctum.middleware.validate_csrf_token','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store',
...
'app.invoice.duplicate','app.invoice.pdf','app.documents.document_types.index','app.documents.document_types.create','app.documents.document_types.store',
'app.documents.document_types.edit','app.documents.document_types.update','app.onboarding','app.logout','tenant.impersonate',
'login','login.store','password.request','password.email','password.reset',
'password.store',);
        registerArgumentsSet('views', 
'app','components.footer','components.layout','generated.emails.verify-email','pdf.invoice.caption',
'pdf.invoice.defaultLine','pdf.invoice.index','pdf.invoice.text','pdf.proof-of-activity.index','laradumps::output',
...
'PLOI_API_BASE_URL','CONVERSION_RATES_API_KEY','CONVERSION_RATES_API_HOST','GOTENBERG_URL','MAPBOX_API_KEY',
