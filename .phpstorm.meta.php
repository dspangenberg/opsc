...
'migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains',
'sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix','sanctum.middleware.authenticate_session',
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver',
...
'app.offer.details','app.offer.history','app.offer.terms','app.offer.lines-update','app.offer.pdf',
'app.offer.section.index','app.offer.section.create','app.offer.section.store','app.offer.section.edit','app.offer.section.update',
'app.offer.section.delete','app.documents.document_types.index','app.documents.document_types.create','app.documents.document_types.store','app.documents.document_types.edit',
...
'app.setting.text-module.store','app.setting.text-module.edit','app.setting.text-module.update','app.setting.text-module.delete','app.onboarding',
...
'http-statuses.598','http-statuses.599','http-statuses.unknownError','validation.attributes.company_house_name','validation.attributes.email',
'validation.attributes.first_name','validation.attributes.last_name','validation.attributes.zip',);
