...
'mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Avifenc','pdf.ghostscript_path','purify.default','purify.configs.default.Core.Encoding','purify.configs.default.HTML.Doctype',
...
'typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','webauthn.relying_party.name','webauthn.relying_party.id',
...
'migrations-generator.filename_pattern.table','migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','boost.enabled',
'boost.browser_logs_watcher','mcp.redirect_domains','sanctum.stateful','sanctum.guard','sanctum.expiration',
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','structure-discoverer.ignored_files',
