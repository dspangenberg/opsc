...
'app.times.delete','app.bookkeeping.transactions.index','app.bookkeeping.transactions.money-money-import','app.contact.details','app.contact.edit.address',
'app.contact.create.address','app.contact.toggle-favorite','app.contact.address.update','test.upload','simple.test',
'app.contact.address.store','app.invoice.create','app.invoice.index','app.invoice.details','app.invoice.history',
'app.invoice.store','app.invoice.delete','app.invoice.base-edit','app.invoice.unrelease','app.invoice.release',
'app.invoice.mark-as-sent','app.invoice.line-duplicate','app.invoice.line-edit','app.invoice.line-update','app.invoice.line-delete',
