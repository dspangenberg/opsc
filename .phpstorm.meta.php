...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','data.date_format',
...
'debugbar.storage.connection','debugbar.storage.provider','debugbar.storage.hostname','debugbar.storage.port','debugbar.use_dist_files',
...
'hashids.connections.alternative.length','hashids.salt','hashids.length','hashids.alphabet','ide-helper.filename',
...
'mail.markdown.paths','markable.user_model','markable.table_prefix','markable.allowed_values.reaction','mediable.connection_name',
...
'services.ploi.base_url','services.gotenberg.url','services.vat_currency_rates.host','services.vat_currency_rates.key','session.driver',
...
'settings.auto_discover_settings','settings.discovered_settings_cache_path','solo.theme','solo.themes.light','solo.themes.dark',
'solo.keybinding','solo.keybindings.default','solo.keybindings.vim','solo.commands.About','solo.commands.Logs',
'solo.commands.Vite','solo.commands.Make','solo.commands.Dumps','solo.commands.Reverb','solo.commands.Pint',
'solo.commands.Queue','solo.commands.Tests','solo.use_screen','solo.dump_server_host','tenancy.models.tenant',
...
'trail.output.routes','trail.output.typescript','typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers',
...
'notable.order_by_direction','inertia.ssr.enabled','inertia.ssr.url','inertia.ssr.ensure_bundle_exists','inertia.ensure_pages_exist',
...
'boost.browser_logs_watcher','mcp.redirect_domains','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'app.dashboard','app.bookkeeping.transactions.confirm','app.bookkeeping.transactions.set-counter-account','app.bookkeeping.bookings.index','app.bookkeeping.bookings.export',
...
'app.bookkeeping.receipts.index','app.bookkeeping.receipts.lock','app.bookkeeping.receipts.rule','app.bookkeeping.receipts.confirm-first','app.bookkeeping.receipts.update',
...
'app.bookkeeping.receipts.edit','app.contact.index','app.contact.create','app.contact.create-person','app.contact.store-person',
'app.contact.store','app.contact.details','app.contact.edit','app.contact.update','app.contact.details.persons',
'app.contact.toggle-favorite','app.contact.note-store','app.contact.archive','app.contact.delete','app.document.preview',
'app.document.pdf','app.document.toggle-pinned','app.document.bulk-force-delete','app.document.force-delete','app.document.trash',
'app.document.restore','app.document.edit','app.document.update','app.document.multi-upload','app.document.index',
'app.document.upload','app.document.upload-form','app.invoice.create','app.invoice.index','app.invoice.details',
...
'app.invoice.duplicate','app.invoice.pdf','app.invoice.cancel','app.offer.create','app.offer.index',
...
'app.profile.edit','app.profile.update','verification.send','app.setting.system','app.setting.system.user.index',
'app.setting.system.user.create','app.setting.system.user.store','app.setting.system.user.edit','app.setting.system.user.update','app.setting.system.user.delete',
'app.setting.system.user.reset-password','app.time.create','app.time.store','app.time.index','app.time.billable',
...
'app','components.footer','components.layout','components.pdf.info-box','generated.invoice',
'generated.recurring-invoice','generated.reset-password','generated.verify-email','generated.verify-new-email','pdf.invoice.caption',
'pdf.invoice.defaultLine','pdf.invoice.index','pdf.invoice.text','pdf.offer.caption','pdf.offer.defaultLine',
'pdf.offer.index','pdf.offer.text','pdf.proof-of-activity.index','vendor.verify-new-email.verifyFirstEmail','vendor.verify-new-email.verifyNewEmail',
'verify-new-email::verifyFirstEmail','verify-new-email::verifyNewEmail','laradumps::output','laradumps::summary','laravel-exceptions-renderer::components.badge',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','verify-new-email::verifyFirstEmail',
'verify-new-email::verifyNewEmail',);
