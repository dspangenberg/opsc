...
'filesystems.disks.s3.throw','filesystems.disks.json.driver','filesystems.disks.json.root','filesystems.disks.json.throw','filesystems.disks.s3_private.driver',
...
'filesystems.disks.s3_private.endpoint','filesystems.disks.s3_private.use_path_style_endpoint','filesystems.disks.s3_private.throw','filesystems.links./Users/dspangenberg/Projects/twiceware.cloud/opsc/public/storage','hashids.salt',
'hashids.length','hashids.alphabet','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','mail.default','mail.mailers.smtp.scheme','mail.mailers.smtp.transport','mail.mailers.smtp.url',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mediable.connection_name','mediable.model',
...
'mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle','mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Cwebp','mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Avifenc','queue.default','queue.connections.sync.driver',
...
'solo.commands.Pint','solo.commands.Queue','solo.commands.Tests','solo.dump_server_host','tenancy.models.tenant',
...
'webauthn.challenge.key','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'inertia.history.encrypt','inertiaui-modal.bind_extended_redirector','sanctum.stateful','sanctum.guard','sanctum.expiration',
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','markable.user_model',
'markable.table_prefix','markable.allowed_values.reaction','settings.settings','settings.setting_class_path','settings.migrations_paths',
...
'app.dashboard','app.accommodation.create','app.accommodation.address.store','app.calendar.create','app.calendar.store',
'app.calendar','app.calendar','app.accommodation.index','app.contact.index','app.accommodation.details',
'app.accommodation.base.store','app.accommodation.contact.store','app.accommodation.store','app.soon','app.settings.email.smtp',
'app.settings.email.inboxes','app.settings.email.inboxes.create','app.settings.email.inboxes.edit','app.settings.email.inboxes.store','app.settings.email.inboxes.update',
'app.settings.booking.seasons','app.settings.booking.seasons.edit','app.settings.booking.seasons.create','app.settings.booking.seasons.update','app.settings.booking.seasons.store',
'app.settings.booking.policies','app.settings.booking.policies.edit','app.settings.booking.policies.create','app.settings.booking.cancellation','app.settings.booking.group-of-people',
'app.settings.policies.booking','app.settings.policies.cancellation','app.onboarding','app.logout','webauthn.register.options',
'webauthn.register','webauthn.login.options','webauthn.login','tenant.impersonate','login',
'login.store','password.request','password.email','password.reset','password.store',);
        registerArgumentsSet('views', 
'app','generated.emails.verify-email','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_BUCKET','AWS_BUCKET_PRIVATE',
'AWS_ACCESS_KEY_ID','AWS_USE_PATH_STYLE_ENDPOINT','AWS_SECRET_ACCESS_KEY','AWS_ENDPOINT','AWS_DEFAULT_REGION',
'VITE_APP_NAME','VITE_APP_URL','PLOI_ACCESS_TOKEN','PLOI_SERVER_ID','PLOI_BACKUP_PROFILE_ID',
'PLOI_API_BASE_URL','MAPBOX_API_KEY','GOOGLE_MAPS_KEY','VITE_APP_GMAPS_KEY','VITE_APP_MAPBOX_API_KEY',
'VITE_SENTRY_DNS','VITE_SENTRY_ENABLED',);
