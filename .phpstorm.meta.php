...
'laradumps.queries.ignore_sql_patterns','laradumps.queries.ignore_routes_patterns','laradumps.enabled','logging.default','logging.deprecations.channel',
...
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','sanctum.stateful','sanctum.guard',
...
'wayfinder.generate.models','wayfinder.generate.inertia.shared_data','wayfinder.generate.broadcast.channels','wayfinder.generate.broadcast.events','wayfinder.generate.environment_variables',
'wayfinder.generate.enums','wayfinder.format.enabled','wayfinder.cache.enabled','wayfinder.cache.directory','sentry.dsn',
...
'sentry.tracing.notifications','sentry.tracing.missing_routes','sentry.tracing.continue_after_response','sentry.tracing.default_integrations','structure-discoverer.ignored_files',
...
'AWS_DEFAULT_REGION','AWS_URL','AWS_URL_PRIVATE','AWS_ENDPOINT','VITE_APP_NAME',
'VITE_APP_URL','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','PLOI_ACCESS_TOKEN',
'PLOI_SERVER_ID','PLOI_BACKUP_PROFILE_ID','PLOI_API_BASE_URL','CONVERSION_RATES_API_KEY','CONVERSION_RATES_API_HOST',
'GOTENBERG_URL','PDF_WEASYPRINT_PATH','PDF_PDFCPU_PATH','PDF_PDFCPU_WATERMARK_FONT','PDF_TERMS_DOCUMENT_ID',
...
'NEXT_PUBLIC_SUPABASE_URL','NEXT_PUBLIC_SUPABASE_PUBLISHABLE_OR_ANON_KEY','LARADUMPS_ENABLED',);
