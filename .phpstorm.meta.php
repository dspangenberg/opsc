...
'app.invoice.duplicate','app.invoice.pdf','app.invoice.cancel','app.invoice.bulk-mark-as-sent','app.offer.create',
...
'impersonate.leave','profile.clear-pending-mail-address','app.time.create','app.time.store','app.time.index',
'app.time.billable','app.time.my-week','app.time.bill','app.time.edit','app.time.update',
'app.time.pdf','app.times.delete','app.onboarding','app.logout','tenant.impersonate',
