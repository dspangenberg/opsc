...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories',
...
'app.contact.create','app.contact.store','app.contact.details','app.contact.edit','app.contact.update',
'app.contact.details.persons','app.contact.edit.address','app.contact.create.address','app.contact.toggle-favorite','app.contact.address.update',
'app.contact.address.store','app.contact.note-store','app.documents.document_types.index','app.documents.document_types.create','app.documents.document_types.store',
'app.documents.document_types.edit','app.documents.document_types.update','app.documents.documents.preview','app.documents.documents.pdf','app.documents.documents.bulk-force-delete',
'app.documents.documents.force-delete','app.documents.documents.trash','app.documents.documents.restore','app.documents.documents.edit','app.documents.documents.update',
'app.documents.documents.multi-upload','app.documents.documents.index','app.documents.documents.upload','app.documents.documents.upload-form','app.invoice.create',
...
'app.invoice.unrelease','app.invoice.release','app.invoice.mark-as-sent','app.invoice.line-duplicate','app.invoice.line-create',
'app.invoice.line-edit','app.invoice.line-update','app.invoice.lines-update','app.invoice.line-store','app.invoice.booking-create',
'app.invoice.line-delete','app.invoice.base-update','app.invoice.duplicate','app.invoice.pdf','app.offer.create',
'app.offer.index','app.offer.store','app.offer.edit','app.offer.details','app.offer.update',
'app.offer.history','app.offer.terms','app.offer.lines-update','app.offer.pdf','app.offer.duplicate',
'app.offer.destroy','app.offer.mark-as-sent','app.offer.update-terms','app.project.index','app.project.create',
'app.project.store','app.project.details','app.project.edit','app.project.update','app.project.delete',
...
'app.setting.layout.store','app.setting.layout.edit','app.setting.layout.update','app.setting.layout.delete','app.time.create',
