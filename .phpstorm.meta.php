...
'app.invoice.details','app.invoice.pdf','app.soon','app.onboarding','app.logout',
'webauthn.register.options','webauthn.register','webauthn.login.options','webauthn.login','tenant.impersonate',
