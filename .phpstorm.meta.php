...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/dspangenberg/Entwicklung/twiceware.cloud/ecting/public/storage' => 'string',
            'hashids.salt' => 'string',
            ...
            'tenancy.identification.central_domains' => 'string',
            'tenancy.identification.default_middleware' => 'string',
            'tenancy.identification.middleware' => 'string',
            'tenancy.identification.domain_identification_middleware' => 'string',
            'tenancy.identification.path_identification_middleware' => 'string',
            ...
            'tenancy.redis.prefixed_connections' => 'string',
            ...
            'typescript-transformer.auto_discover_types' => 'string',
            'typescript-transformer.collectors' => 'string',
            'typescript-transformer.transformers' => 'string',
            ...
            'mediable.aggregate_types.image.mime_types' => 'string',
            'mediable.aggregate_types.image.extensions' => 'string',
            'mediable.aggregate_types.vector.mime_types' => 'string',
            'mediable.aggregate_types.vector.extensions' => 'string',
            'mediable.aggregate_types.pdf.mime_types' => 'string',
            'mediable.aggregate_types.pdf.extensions' => 'string',
            'mediable.aggregate_types.audio.mime_types' => 'string',
            'mediable.aggregate_types.audio.extensions' => 'string',
            'mediable.aggregate_types.video.mime_types' => 'string',
            'mediable.aggregate_types.video.extensions' => 'string',
            'mediable.aggregate_types.archive.mime_types' => 'string',
            'mediable.aggregate_types.archive.extensions' => 'string',
            'mediable.aggregate_types.document.mime_types' => 'string',
            'mediable.aggregate_types.document.extensions' => 'string',
            'mediable.aggregate_types.spreadsheet.mime_types' => 'string',
            'mediable.aggregate_types.spreadsheet.extensions' => 'string',
            'mediable.aggregate_types.presentation.mime_types' => 'string',
            'mediable.aggregate_types.presentation.extensions' => 'string',
            ...
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Jpegoptim' => 'string',
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Pngquant' => 'string',
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Optipng' => 'string',
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Gifsicle' => 'string',
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Cwebp' => 'string',
            'mediable.image_optimization.optimizers.Spatie\ImageOptimizer\Optimizers\Avifenc' => 'string',
...
'filesystems.disks.json.driver','filesystems.disks.json.root','filesystems.disks.json.throw','filesystems.links./Users/dspangenberg/Entwicklung/twiceware.cloud/ecting/public/storage','hashids.salt',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','mediable.connection_name',
...
'mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng','mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle','mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Cwebp','mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Avifenc','structure-discoverer.ignored_files',
...
'app.accommodation.index','app.accommodation.details','app.accommodation.base.store','app.accommodation.contact.store','app.accommodation.store',
'app.soon','app.settings.email.smtp','app.settings.email.inboxes','app.settings.email.inboxes.create','app.settings.email.inboxes.edit',
'app.settings.email.inboxes.store','app.settings.email.inboxes.update','app.settings.booking.seasons','app.settings.booking.seasons.edit','app.settings.booking.seasons.create',
'app.settings.booking.seasons.update','app.settings.booking.seasons.store','app.settings.booking.policies','app.settings.booking.policies.edit','app.settings.booking.policies.create',
'app.settings.booking.cancellation','app.settings.booking.group-of-people','app.settings.policies.booking','app.settings.policies.cancellation','app.onboarding',
'app.logout','webauthn.register.options','webauthn.register','webauthn.login.options','webauthn.login',
...
'de.0','http-statuses.0','http-statuses.100','http-statuses.101','http-statuses.102',
...
'validation.attributes.email','validation.attributes.first_name','validation.attributes.last_name','validation.attributes.zip','en.0',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_BUCKET','AWS_ACCESS_KEY_ID',
'AWS_USE_PATH_STYLE_ENDPOINT','AWS_SECRET_ACCESS_KEY','AWS_ENDPOINT','AWS_DEFAULT_REGION','VITE_APP_NAME',
'VITE_APP_URL','PLOI_ACCESS_TOKEN','PLOI_SERVER_ID','PLOI_BACKUP_PROFILE_ID','PLOI_API_BASE_URL',
