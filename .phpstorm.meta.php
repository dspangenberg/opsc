...
'mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Avifenc','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'solo.commands.Tests','solo.dump_server_host','tenancy.models.tenant','tenancy.models.domain','tenancy.models.tenant_key_column',
...
'webauthn.origins','webauthn.challenge.bytes','webauthn.challenge.timeout','webauthn.challenge.key','hashing.driver',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','inertia.ssr.enabled','inertia.ssr.url',
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','inertiaui-modal.bind_extended_redirector',
...
'app.dashboard','app.contact.index','app.contact.details','app.contact.edit.address','app.contact.toggle-favorite',
'app.invoice.index','app.invoice.details','app.soon','app.onboarding','app.logout',
