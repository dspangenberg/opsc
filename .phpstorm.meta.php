...
'cloud.register.verify','cloud.register.credentials','cloud.register','storage.local','app.dashboard','app.time.create','app.time.store','app.time.index',
'app.time.billable','app.time.my-week','app.time.bill','app.time.edit','app.time.update',
'app.time.pdf','app.times.delete','app.bookkeeping.transactions.confirm','app.bookkeeping.transactions.set-counter-account','app.bookkeeping.bookings.index',
...
'app.contact.address.store','app.contact.note-store','app.invoice.create','app.invoice.index','app.invoice.details',
...
'app.invoice.mark-as-sent','app.invoice.line-duplicate','app.invoice.line-create','app.invoice.line-edit','app.invoice.line-update',
...
'app.offer.update-terms','app.documents.document_types.index','app.documents.document_types.create','app.documents.document_types.store','app.documents.document_types.edit',
'app.documents.document_types.update','app.documents.documents.preview','app.documents.documents.pdf','app.documents.documents.bulk-force-delete','app.documents.documents.force-delete',
'app.documents.documents.trash','app.documents.documents.restore','app.documents.documents.edit','app.documents.documents.update','app.documents.documents.multi-upload',
'app.documents.documents.index','app.documents.documents.upload','app.documents.documents.upload-form','app.setting.text-module.index','app.setting.text-module.create',
'app.setting.text-module.store','app.setting.text-module.edit','app.setting.text-module.update','app.setting.text-module.delete','app.settings.offer-section.index',
'app.settings.offer-section.create','app.settings.offer-section.store','app.settings.offer-section.edit','app.settings.offer-section.update','app.settings.offer-section.delete',
'app.setting.letterhead.global-css-edit','app.setting.letterhead.global-css-update','app.setting.letterhead.index','app.setting.letterhead.create','app.setting.letterhead.store',
'app.setting.letterhead.edit','app.setting.letterhead.update','app.setting.letterhead.delete','app.onboarding','app.logout',
...
'AWS_DEFAULT_REGION','AWS_URL','AWS_ENDPOINT','VITE_APP_NAME','VITE_APP_URL',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','PLOI_ACCESS_TOKEN','PLOI_SERVER_ID',
'PLOI_BACKUP_PROFILE_ID','PLOI_API_BASE_URL','CONVERSION_RATES_API_KEY','CONVERSION_RATES_API_HOST','GOTENBERG_URL',
'PDF_WEASYPRINT_PATH','PDF_PDFCPU_PATH','PDF_PDFCPU_WATERMARK_FONT','PDF_TERMS_DOCUMENT_ID','MAPBOX_API_KEY',
'GOOGLE_MAPS_KEY','VITE_APP_GMAPS_KEY','VITE_APP_MAPBOX_API_KEY','VITE_SENTRY_DNS','VITE_SENTRY_ENABLED',
'VITE_REACT_PDF_LICENSE_KEY','VITE_TIMEZONE','VITE_APP_DATE_FORMAT','VITE_APP_DATE_TIME_FORMAT','NEXT_PUBLIC_SUPABASE_URL',
