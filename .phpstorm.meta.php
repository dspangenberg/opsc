...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.vat_currency_rates.key' => 'NULL',
            ...
            'settings.repositories.database.connection' => 'string',
...
'filesystems.disks.s3_private.url','filesystems.disks.s3_private.endpoint','filesystems.disks.s3_private.use_path_style_endpoint','filesystems.disks.s3_private.throw','filesystems.links./Users/dspangenberg/Entwicklung/twiceware.cloud/opsc/public/storage',
...
'hashids.salt','hashids.length','hashids.alphabet','ide-helper.filename','ide-helper.models_filename',
...
'logging.channels.browser.days','mail.default','mail.mailers.smtp.scheme','mail.mailers.smtp.transport','mail.mailers.smtp.url',
...
'migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','boost.enabled','boost.browser_logs_watcher','sanctum.stateful',
...
'purify.serializer.driver','purify.serializer.cache','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'app.bookkeeping.transactions.confirm','app.bookkeeping.transactions.set-counter-account','app.bookkeeping.bookings.index','app.bookkeeping.transactions.money-money-import','app.bookkeeping.transactions.index',
'app.bookkeeping.receipts.index','app.bookkeeping.receipts.upload','app.bookkeeping.receipts.confirm-first','app.bookkeeping.receipts.update','app.bookkeeping.receipts.pdf',
'app.bookkeeping.receipts.destroy','app.bookkeeping.receipts.confirm','app.bookkeeping.cost-centers.index','app.bookkeeping.cost-centers.create','app.bookkeeping.cost-centers.store',
...
'PLOI_API_BASE_URL','MAPBOX_API_KEY','GOOGLE_MAPS_KEY','CONVERSION_RATES_API_KEY','CONVERSION_RATES_API_HOST',
'GOTENBERG_URL','VITE_APP_GMAPS_KEY','VITE_APP_MAPBOX_API_KEY','VITE_SENTRY_DNS','VITE_SENTRY_ENABLED',
