...
'migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','boost.enabled','boost.browser_logs_watcher',
'mcp.redirect_domains','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'debugbar.queries.explain','boost.browser-logs','sanctum.csrf-cookie','pendingEmail.verify','stancl.tenancy.asset',
...
'storage.local','app.dashboard','app.bookkeeping.transactions.confirm','app.bookkeeping.transactions.set-counter-account',
'app.bookkeeping.bookings.index','app.bookkeeping.bookings.export','app.bookkeeping.transactions.money-money-import','app.bookkeeping.transactions.holvi-import','app.bookkeeping.transactions.index',
'app.bookkeeping.receipts.upload','app.bookkeeping.receipts.upload-form','app.bookkeeping.receipts.index','app.bookkeeping.receipts.lock','app.bookkeeping.receipts.rule',
...
'app.bookkeeping.receipts.payments-store','app.bookkeeping.receipts.confirm','app.bookkeeping.receipts.edit','app.contact.index','app.contact.create',
...
'app.contact.delete','app.document.preview','app.document.pdf','app.document.toggle-pinned','app.document.bulk-force-delete',
'app.document.force-delete','app.document.trash','app.document.restore','app.document.edit','app.document.update',
'app.document.multi-upload','app.document.index','app.document.upload','app.document.upload-form','app.invoice.create',
'app.invoice.index','app.invoice.details','app.invoice.link-on-account-invoice','app.invoice.link-on-account-store','app.invoice.create.payment',
'app.invoice.store.payment','app.invoice.history','app.invoice.store','app.invoice.delete','app.invoice.base-edit',
'app.invoice.unrelease','app.invoice.release','app.invoice.mark-as-sent','app.invoice.line-duplicate','app.invoice.lines-update',
'app.invoice.line-store','app.invoice.booking-create','app.invoice.line-delete','app.invoice.base-update','app.invoice.duplicate',
'app.invoice.pdf','app.offer.create','app.offer.index','app.offer.store','app.offer.edit',
...
'app.profile.edit','app.profile.password-update','app.setting.system','app.setting.system.user.index','app.setting.system.user.create',
'app.setting.system.user.store','app.setting.system.user.edit','app.setting.system.user.update','app.time.create','app.time.store',
...
'generated.reset-password','generated.verify-email','pdf.invoice.caption','pdf.invoice.defaultLine','pdf.invoice.index',
'pdf.invoice.text','pdf.offer.caption','pdf.offer.defaultLine','pdf.offer.index','pdf.offer.text',
'pdf.proof-of-activity.index','laradumps::output','laradumps::summary','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'http-statuses.527','http-statuses.598','http-statuses.599','http-statuses.unknownError','validation.attributes.company_house_name',
'validation.attributes.current_password','validation.attributes.email','validation.attributes.first_name','validation.attributes.last_name','validation.attributes.password',
'validation.attributes.zip',);
