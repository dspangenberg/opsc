...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dspangenberg/Projects/twiceware.cloud/opsc/public/storage' => 'string',
            'hashids.salt' => 'string',
            ...
            'inertiaui-modal.bind_extended_redirector' => 'boolean',
...
'filesystems.disks.s3_private.throw','filesystems.links./home/dspangenberg/Projects/twiceware.cloud/opsc/public/storage','hashids.salt','hashids.length','hashids.alphabet',
...
'webauthn.challenge.bytes','webauthn.challenge.timeout','webauthn.challenge.key','broadcasting.default','broadcasting.connections.reverb.driver',
...
'hashing.rehash_on_login','concurrency.default','view.paths','view.compiled','cors.paths',
...
'inertia.testing.page_extensions','inertia.history.encrypt','inertiaui-modal.bind_extended_redirector','migrations-generator.migration_template_path','migrations-generator.migration_target_path',
'migrations-generator.filename_pattern.table','migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','sanctum.stateful',
...
'sanctum.middleware.validate_csrf_token','settings.settings','settings.setting_class_path','settings.migrations_paths','settings.default_repository',
...
'settings.global_casts.Spatie\\LaravelData\\Data','settings.auto_discover_settings','settings.discovered_settings_cache_path','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories',
...
'app.dashboard','app.contact.index','app.time.index','app.time.my-week','app.contact.details',
'app.contact.edit.address','app.contact.create.address','app.contact.toggle-favorite','app.contact.address.update','app.contact.address.store',
'app.invoice.index','app.invoice.details','app.invoice.history','app.invoice.delete','app.invoice.base-edit',
'app.invoice.lines-edit','app.invoice.unrelease','app.invoice.release','app.invoice.mark-as-sent','app.invoice.line-duplicate',
'app.invoice.line-edit','app.invoice.line-update','app.invoice.line-delete','app.invoice.base-update','app.invoice.duplicate',
'app.invoice.pdf','app.onboarding','app.logout','tenant.impersonate','login',
...
'PLOI_ACCESS_TOKEN','PLOI_SERVER_ID','PLOI_BACKUP_PROFILE_ID','PLOI_API_BASE_URL','MAPBOX_API_KEY',
'GOOGLE_MAPS_KEY','VITE_APP_GMAPS_KEY','VITE_APP_MAPBOX_API_KEY','VITE_SENTRY_DNS','VITE_SENTRY_ENABLED',
'VITE_TIMEZONE','VITE_APP_DATE_FORMAT','VITE_APP_DATE_TIME_FORMAT',);
