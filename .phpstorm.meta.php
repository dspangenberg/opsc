...
'mediable.image_optimization.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Avifenc','purify.default','purify.configs.default.Core.Encoding','purify.configs.default.HTML.Doctype','purify.configs.default.HTML.Allowed',
...
'typescript-transformer.writer','typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','webauthn.relying_party.name',
...
'boost.browser_logs_watcher','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'app.bookkeeping.transactions.confirm','app.bookkeeping.transactions.set-counter-account','app.bookkeeping.bookings.index','app.bookkeeping.transactions.money-money-import','app.bookkeeping.transactions.holvi-import',
'app.bookkeeping.transactions.index','app.bookkeeping.receipts.index','app.bookkeeping.receipts.upload','app.bookkeeping.receipts.confirm-first','app.bookkeeping.receipts.update',
...
'app.bookkeeping.receipts.edit','app.bookkeeping.cost-centers.index','app.bookkeeping.cost-centers.create','app.bookkeeping.cost-centers.store','app.bookkeeping.cost-centers.edit',
'app.bookkeeping.cost-centers.update','app.contact.index','app.contact.create','app.contact.store','app.contact.details',
'app.contact.edit','app.contact.update','app.contact.details.persons','app.contact.edit.address','app.contact.create.address',
'app.contact.toggle-favorite','app.contact.address.update','app.contact.address.store','app.contact.note-store','app.invoice.create',
...
'app.invoice.line-edit','app.invoice.line-update','app.invoice.line-store','app.invoice.booking-create','app.invoice.line-delete',
'app.invoice.base-update','app.invoice.duplicate','app.invoice.pdf','app.onboarding','app.logout',
