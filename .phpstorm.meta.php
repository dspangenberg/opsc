...
'cors.max_age','cors.supports_credentials','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','inertiaui-modal.bind_extended_redirector','migrations-generator.migration_template_path',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','settings.settings','settings.setting_class_path','settings.migrations_paths',
...
'settings.global_casts.DateTimeZone','settings.global_casts.Spatie\\LaravelData\\Data','settings.auto_discover_settings','settings.discovered_settings_cache_path','structure-discoverer.ignored_files',
...
'validation.uuid','validation.custom.attribute-name.rule-name','de.0','http-statuses.0','http-statuses.100',
...
'http-statuses.unknownError','validation.attributes.company_house_name','validation.attributes.email','validation.attributes.first_name','validation.attributes.last_name',
'validation.attributes.zip','en.0',);
