...
'debugbar.queries.explain','sanctum.csrf-cookie','stancl.tenancy.asset','tenant.stancl.tenancy.asset','app.dashboard','app.accommodation.create','app.accommodation.address.store','app.calendar.create',
'app.calendar.store','app.calendar','app.calendar','app.accommodation.index','app.contact.index',
'app.accommodation.details','app.accommodation.base.store','app.accommodation.contact.store','app.accommodation.store','app.soon',
'app.settings.email.smtp','app.settings.email.inboxes','app.settings.email.inboxes.create','app.settings.email.inboxes.edit','app.settings.email.inboxes.store',
'app.settings.email.inboxes.update','app.settings.booking.seasons','app.settings.booking.seasons.edit','app.settings.booking.seasons.create','app.settings.booking.seasons.update',
'app.settings.booking.seasons.store','app.settings.booking.policies','app.settings.booking.policies.edit','app.settings.booking.policies.create','app.settings.booking.cancellation',
'app.settings.booking.group-of-people','app.settings.policies.booking','app.settings.policies.cancellation','app.onboarding','app.logout',
'webauthn.register.options','webauthn.register','webauthn.login.options','webauthn.login','login',
