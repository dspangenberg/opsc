...
return [
     ...
     *
     * This is intended to be used as a security measure to prevent potentially executable files from being uploaded.
     * It should include any file extension which is configured to be executable by your web server.
     */
    'forbidden_extensions' => [
        'php', 'php3', 'php4', 'php5', 'php6', 'php7', 'php8',
        'phtml', 'phar', 'phpt', 'pgif', 'shtml', 'shtm', 'stm',
        'pl', 'cgi', 'py', 'asp', 'aspx', 'ashx', 'jsp', 'jspx',
        'cfm', 'cfml', 'htaccess', 'htpasswd',
    ],
