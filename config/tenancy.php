...
return [
    ...
    'identification' => [
         ...
         *
         * This is used during determining  whether a path identification is used
    ...
    'cache' => [
        ...
        // This format, with the %tenant% replaced by the tenant key, and prepended by the original store prefix, will form a cache prefix that will be used for every cache key.
        'stores' => [
            env('CACHE_STORE'),
        ],
    ...
    'redis' => [
        'prefix' => 'tenant_%tenant%_',
        // Each key in Redis will be prepended by this prefix format, with %tenant% replaced by the tenant key.
