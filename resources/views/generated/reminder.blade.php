            ...
            <table style="margin-top: 16px; width: 100%;" cellpadding="0" cellspacing="0" role="none">
              ...
              <tr>
                <td class="sm-p-6" style="border-top-left-radius: 8px; border-top-right-radius: 8px; background-color: #fffffe; padding: 24px 36px; text-align: left; border: 1px solid #e2e8f0">
                  ...
                  <h1 style="margin: 0 0 24px; font-size: 1.0rem; line-height: 24px; font-weight: 600; color: #0f172a;">
                    @if($name)
                    Guten Tag, {{ $name }},
                    @else
                    Guten Tag,
                  ...
                  <p style="margin: 0 0 24px; font-size: 1.0rem; line-height: 24px; color: #475569;">
                    im Anhang dieser E-Mail senden wir Ihnen die {{ $type }} für unsere Rechnung {{ $invoice_number }} vom {{ $invoice_date }} im PDF-Format.
                  </p>
                  <p style="margin: 0; font-size: 1.0rem; line-height: 24px; color: #475569;">
                    Freundliche Grüße nach {{ $city }}<br>
