...
import {Button, FormCheckbox, FormErrors, FormGroup, FormInput} from '@dspangenberg/twcui'
...
const Login: React.FC<LoginProps> = ({canResetPassword}) => {
    ...
    const loginContent = (
        <AuthContainer title="Login" logo={<Logo className=""/>} cardTitle="Willkommen zurück"
