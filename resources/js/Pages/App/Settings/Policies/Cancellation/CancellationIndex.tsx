    ...
    <SettingsLayout>
      <div className="h-full rounded-lg border-stone-100 px-4 flex flex-col">
        <Toolbar
          ...
          className="flex-none"
          tabs={
            <SettingsTabs url={'/app/settings/policies'} />
          }
        >
          <ToolbarButton
            variant="primary"
            label="Stornorichtlinien hinzufügen"
            icon={Add01Icon}
            onClick={handleAdd}
          />
        ...
        <div className="flex-none flex">
          <div className="py-6 w-full justify-center space-y-6 items-center text-center rounded-lg text-sm text-muted-foreground">
            <EmptyState buttonLabel="Erste Stornorichtlinie hinzufügen" onClick={handleAdd}>
              Ups, Du hast noch keine Stornorichtlinien
            </EmptyState>
          </div>
        </div>
      </div>
