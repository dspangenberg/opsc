...
const editUrl = (id: number | null) => (id ? route('app.setting.text-module.edit', { id }) : '#')

const deleteSection = async (row: App.Data.TextModuleData) => {
...
const RowActions = ({ row }: { row: Row<App.Data.TextModuleData> }) => {
  return (
...
export const columns: ColumnDef<App.Data.TextModuleData>[] = [
  {
    id: 'select',
    size: 30,
    header: ({ table }) => (
