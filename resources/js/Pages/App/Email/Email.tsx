import { MailUpload01Icon } from '@hugeicons/core-free-icons'
...
export const Email: React.FC<InboxMailProps> = ({ mail, contacts, projects }) => {
  ...
  return (
    <div className="md-editor mx-auto mt-8 h-fit w-full max-w-4xl space-y-6 rounded-lg border border-border/80 bg-background shadow">
