...
function DialogHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex flex-col gap-1 text-center sm:text-left bg-accent px-6 py-3', className)}
      {...props}
    />
  )
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex flex-col-reverse sm:flex-row sm:justify-end px-6 py-3 bg-accent',
        className
      )}
      {...props}
    />
