...
const fieldBorderStyles = tv({
  base: "group-focus:ring-[3px] group-focus:ring-ring/50 ",
  variants: {
    isInvalid: {
      true: "group-focus:border-danger/70",
    },
    isDisabled: {
      ...
      >
        {(renderProps) => (
          <>
            ...
            <Input className="px-13 tabular-nums border-transparent md:px-2.5 " placeholder={placeholder} />
            {!isMobile ? (
              <div
