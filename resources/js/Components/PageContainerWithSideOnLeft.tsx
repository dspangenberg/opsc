...
export const PageContainerWithSideOnLeft: React.FC<PageContainerProps> = ({
  title,
  width = '7xl',
  header,
  toolbar,
  ...
  return (
    <div className="absolute inset-0 flex flex-col overflow-hidden bg-page-content">
      ...
      <div className={cn('relative flex-1 bg-page-content', backgroundClass)}>
        <LayoutContainer
          className={cn(
            'absolute inset-0 min-h-0 flex-col gap-2 overflow-y-auto px-4 xl:flex-row!',
            className
          )}
        >
          {children}
